...
function ListingPage2(){
    ...
    return (
        <div className = 'w-[100%] h-[100vh] bg-[white] flex items-start justify-center relative overflow-auto'>
            ...
            <div className = 'max-w-[900px] w-[100%] h-[650px] overflow-auto bg-[white] flex items-center justify-start flex-col gap-[40px] mt-[110px]'>
                <h1 className = 'text-[18px] text-[black] md:text-[30px]'>Which of These Best Describes Your place ?</h1>

             <div className = 'max-w-[900px] w-[100%] h-[650px] flex flex-wrap items-center justify-center gap-[15px] md:w-[70%]'>
                <div className = {`w-[180px] h-[100px] flex items-center justify-center flex-col cursor-pointer border-[2px] hover:border-[#a6a5a5] text-[16px] rounded-lg
                ...
                <div className = {`w-[180px] h-[100px] flex items-center justify-center flex-col cursor-pointer border-[2px] hover:border-[#a6a5a5] text-[16px] rounded-lg
                    ${category == "pool" ? "border-3 border-[#8b8b8b]": ""}`}
                ...
                <div className = {`w-[180px] h-[100px] flex items-center justify-center flex-col cursor-pointer border-[2px] hover:border-[#a6a5a5] text-[16px] rounded-lg
                    ${category == "formHouse" ? "border-3 border-[#8b8b8b]": ""}`}
                     onClick = {() => setCategory("formHouse")}>
            ...
            <button className ='px-[50px] py-[10px] bg-[red] text-[20px] text-[white] rounded-lg absolute right-[7%] bottom-[10%]'
              onClick = {() => navigate("/listingPage3")} disabled = {!category}>Next</button>
